...
import { decrementProduct, incrementProduct, moveToShipping } from '../../redux/cartSlice';
import { useNavigate } from 'react-router-dom';

const NavigationButtons = ({ backRoute, handleNext, mobile, desktop, disableBackButton }) => {
  return (
